...
import { getSearchEntities, getEntities } from './borrowed-book.reducer';
...
export const BorrowedBook = (props: IBorrowedBookProps) => {
  ...
  const { borrowedBookList, match, totalItems } = props;
  return (
    <div>
      ...
      <div className="table-responsive">
        {borrowedBookList && borrowedBookList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('borrowDate')}>
                  Borrow Date <FontAwesomeIcon icon="sort" />
                </th>
                <th>
          ...
          <div className="alert alert-warning">No Borrowed Books found</div>
        )}
      </div>
